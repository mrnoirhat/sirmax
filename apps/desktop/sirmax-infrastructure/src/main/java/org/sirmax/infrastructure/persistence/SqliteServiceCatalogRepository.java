...
public final class SqliteServiceCatalogRepository implements ServiceCatalogRepository {
    ...
    public void saveVersion(ServiceDefinitionVersion v) {
        JdbcHelper.update(
                ...
                ServiceJson.formSchemaToJson(v.formSchema()),
                ServiceJson.workflowToJson(v.workflow()),
                ServiceJson.feeRulesToJson(v.feeRules()),
    ...
    private static ServiceDefinitionVersion mapVersion(ResultSet rs) throws SQLException {
        ...
        return new ServiceDefinitionVersion(
                ...
                ServiceJson.feeRulesFromJson(rs.getString("fee_rules_json")),
                ServiceJson.formSchemaFromJson(rs.getString("form_schema_json")),
                ServiceJson.workflowFromJson(rs.getString("workflow_json")),
